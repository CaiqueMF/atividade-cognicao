...
<div class="tela" on:click={()=>trocar()}>
    ...
    <img class= "ovaldo" src={ovo} alt="ovo" style="--theme-width: {tamanhoOvo}; --offset: {offsetOvo}">
    <img class="aafolou" src={cachorro} alt="cachorro" style="--theme-width: {tamanhoCachorro}; --offset: {offsetCachorro}">
    ...
    <div class="dialogo">
        ...
        {:else if atual == 1}
            <p>Por que <span class="verde">toda vez</span> que eu pego ele me dá carinho... É um reforço <span>
